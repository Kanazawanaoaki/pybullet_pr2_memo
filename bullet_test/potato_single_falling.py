...
# c.f. https://github.com/HiroIshida/snippets/blob/master/python/pybullet/falling.py
...
tray_id = p.loadURDF("model/pot/model.urdf")
ball_id = p.loadURDF("model/potato1/model.urdf")
set_point(ball_id, [rn.randn()*0.04, rn.randn()*0.04, 0.2 + rn.random()*2])
